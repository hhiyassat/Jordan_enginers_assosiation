...
| CS-04 | [CS-04-application-lookup-contract.md](CS-04-application-lookup-contract.md) | FIXED | (pending) | Contract adopted by SanctionGuard (first production consumer). snapshotOf() helper added; SM_ALLOWED_IMPORTS down from 15 → 14. |
