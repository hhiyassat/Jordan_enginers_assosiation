...
| 2 | `JEA-ESP2-SRS-SITE-SURVEY-001` **v1.2** | `srs/JEA-ESP2-SRS-SITE-SURVEY-001_v1.2.md` | **v1.2** (2026-08-01) supersedes v1.1, v1.0, v0.1 | **AVAILABLE** (350 lines / 40 KB, verified UTF-8 markdown) — closes RES-TD00-01 | Match — Arabic SRS body, JEA-ESP2-SRS-SITE-SURVEY-001, unified extended review draft | **NOT APPROVED** — SRS §header ضابط الاعتماد: "لا تصبح مرجعًا تعاقديًا إلا بعد إغلاق القرارات الحاجبة واعتماد RTM والصلاحيات وتوقيع مالك المتطلبات على خط الأساس 2.0" + §الخلاصة: "تبقى غير معتمدة للتنفيذ النهائي حتى إغلاق الحاجبات وتوقيع خط الأساس 2.0" | Confirms user directive: "Reviewed" ≠ APPROVED. Approval PENDING baseline 2.0. Content reconciled in `TD-00-reconciliation-srs-v12.md` |
