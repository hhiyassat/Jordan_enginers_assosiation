...
class ApplicationController extends Controller
{
    ...
    /**
     * JORD-88 (PM): reviewer dashboard summary.
     *
     * Auditors used to land straight on the queue table with no
     * at-a-glance signal of workload / SLA pressure / weekly output.
     * This endpoint aggregates the four numbers a reviewer wants
     * on login (queue backlog they can act on, their in-progress,
     * their overdue, decisions closed this week) plus two lists
     * to seed the dashboard cards (recent decisions + currently
     * claimed rows).
     *
     * Scoping mirrors reviewQueue():
     *   • Admin sees org-wide numbers (the tiebreaker role).
     *   • staff / auditor sees only rows their role can act on
     *     (matched against schema.workflow.stages[].role).
     */
