...
class ManualReferencesSeeder extends Seeder
{
    ...
    private function references(): array
    {
        return [
            ...
            // ─── SRV-001 — تقارير استطلاع الموقع للأبنية المقترحة ─────
            [
                'jord_ticket'         => 'JORD-84',
                'chapter'             => 'الباب الأول — الفصل الثالث',
                'section'             => 'وجوب استطلاع الموقع للأبنية المقترحة',
                'page'                => 36,
                'rule_type'           => 'workflow',
                'target_type'         => 'service',
                'target_id'           => null,
                'target_service_code' => 'SRV-001',
                'text_ar'             => 'استطلاع الموقع مطلوب للأبنية المقترحة ضمن مراكز المحافظات ووفق حدود المساحة المعتمدة. يُفرَّق في التطبيق بين مراكز المحافظات، أمانة عمّان الكبرى، والمناطق خارج مراكز المحافظات. (كتاب التعليمات الفنية 2025 — الفصل الثالث ص.36)',
            ],
            [
                'jord_ticket'         => 'JORD-85-srv',
                'chapter'             => 'الباب الأول — الفصل الثالث',
                'section'             => 'إرفاق عقد استطلاع الموقع',
                'page'                => 36,
                'rule_type'           => 'document',
                'target_type'         => 'document',
                'target_id'           => 'survey_contract',
                'target_service_code' => 'SRV-001',
                'text_ar'             => 'يوقع المالك أو مندوبه أو المكتب المصمم عقداً مع مكتب فحص التربة أو الاستشاري المؤهَّل لعمل استطلاع الموقع، وتُرفق نسخة من العقد على النظام الإلكتروني المعتمد. (كتاب التعليمات الفنية 2025 — الفصل الثالث ص.36)',
            ],
            [
                'jord_ticket'         => 'JORD-86',
                'chapter'             => 'الباب الأول — الفصل الثالث',
                'section'             => 'رفع التقرير مباشرة إلى النقابة',
                'page'                => 36,
                'rule_type'           => 'workflow',
                'target_type'         => 'document',
                'target_id'           => 'site_investigation_report',
                'target_service_code' => 'SRV-001',
                'text_ar'             => 'يُقدَّم تقرير استطلاع الموقع مباشرة إلى النقابة (وحدة الاستطلاع) لغايات التدقيق الفني والاعتماد، دون أن يمرَّ عبر مكتب المخططات. (كتاب التعليمات الفنية 2025 — الفصل الثالث ص.36)',
            ],
            [
                'jord_ticket'         => 'JORD-87',
                'chapter'             => 'الباب الأول — الفصل الثالث',
                'section'             => 'توقيع التقرير والمسؤولية الفنية',
                'page'                => 37,
                'rule_type'           => 'review',
                'target_type'         => 'document',
                'target_id'           => 'site_investigation_report',
                'target_service_code' => 'SRV-001',
                'text_ar'             => 'يوقّع التقرير رئيس اختصاص المكتب المؤهَّل، ويظهر اسمه صراحةً ورقم تسجيله في النقابة، ويتحمَّل المكتب والمهندس المسؤولية الفنية عن محتوى التقرير. (كتاب التعليمات الفنية 2025 — الفصل الثالث ص.37)',
            ],
            [
                'jord_ticket'         => 'JORD-88',
                'chapter'             => 'الباب الأول — الفصل الثالث',
                'section'             => 'حفظ الآبار السبرية والعينات',
                'page'                => 37,
                'rule_type'           => 'workflow',
                'target_type'         => 'service',
                'target_id'           => null,
                'target_service_code' => 'SRV-001',
                'text_ar'             => 'يجب الاحتفاظ بالآبار السبرية المحفورة والعينات المستخرَجة لمدة عشرة أيام من تاريخ تقديم التقرير لتمكين مدقّقي النقابة من الكشف الميداني عليها إذا لزم. (كتاب التعليمات الفنية 2025 — الفصل الثالث ص.37)',
            ],
            [
                'jord_ticket'         => 'JORD-89',
                'chapter'             => 'الباب الأول — الفصل الثالث',
                'section'             => 'محتوى صفحات التقرير — الحوض والقطعة والمالك',
                'page'                => 34,
                'rule_type'           => 'document',
                'target_type'         => 'rule',
                'target_id'           => 'cadastral_identification_content',
                'target_service_code' => 'SRV-001',
                'text_ar'             => 'يجب أن تحتوي صفحات التقرير الداخلية على: رقم القطعة، اسم ورقم الحوض، اسم مالك المشروع. تُطبع البيانات كما وردت في الوثائق الرسمية دون تغيير في الأرقام. (كتاب التعليمات الفنية 2025 — الفصل الثالث ص.34)',
            ],
            [
                'jord_ticket'         => 'JORD-90',
                'chapter'             => 'الباب الأول — الحد الأدنى لتقارير الاستطلاع',
                'section'             => 'المحتوى الفني للتقرير',
                'page'                => 219,
                'rule_type'           => 'document',
                'target_type'         => 'document',
                'target_id'           => 'site_investigation_report',
                'target_service_code' => 'SRV-001',
                'text_ar'             => 'يتضمَّن تقرير استطلاع الموقع الحد الأدنى من المتطلبات الفنية: وصف الموقع، نتائج الاستكشاف، مقاطع الحفريات، خصائص التربة الجيوتقنية، توصيات التأسيس، وتحذيرات الأخطار الجيولوجية عند وجودها. (كتاب التعليمات الفنية 2025 — الحد الأدنى لتقارير الاستطلاع ص.219)',
            ],
            [
                'jord_ticket'         => 'JORD-91',
                'chapter'             => 'الباب الأول — احتساب أعماق الآبار السبرية',
                'section'             => 'جدول (1) — الحد الأدنى لعدد وعمق نقاط الاستكشاف',
                'page'                => 230,
                'rule_type'           => 'calculation',
                'target_type'         => 'rule',
                'target_id'           => 'exploration_requirement_matrix',
                'target_service_code' => 'SRV-001',
                'text_ar'             => 'الحد الأدنى لعدد الآبار السبرية وعمقها يُحدَّد وفق جدول (1) بحسب عدد طوابق المبنى (حتى 8 طوابق) ومساحة الطابق (حتى 1200م²). عدد الطوابق ≥ 9 أو مساحة الطابق > 1200م² تستوجب دراسة خاصة، وكذلك أبراج النقل والمشاريع الشمسية والمشاريع متعددة المباني. (كتاب التعليمات الفنية 2025 — احتساب أعماق الآبار السبرية ص.230-232)',
            ],
        ];
    }
}
