    ...
    private function tiles(): array
    {
        return [
            ...
            [
                ...
                'name_ar'        => 'مشاريعي',
                'name_en'        => 'My Projects',
                'description_ar' => 'إدارة المشاريع وتقديم طلبات التصديق',
                'description_en' => 'Manage projects and submit approval requests',
            ],
            [
                'code'           => 'JEA-MISC',
                'name_ar'        => 'خدمات متفرقة',
            ...
            [
                'code'           => 'JEA-ENG',
                'name_ar'        => 'المهندسون في المكاتب الهندسية',
                'name_en'        => 'Engineers in Offices',
